classdef Lithology < handle
   ...
   methods
      ...
      % =========================================================   
       ...
       % =========================================================          
       function NewPetroModId =  getNewPetroModId(obj, petroModIds)
           sortedIds = sort(petroModIds);
           newList = (101:(max(petroModIds)+1))';
           setDiffer = setdiff(newList, sortedIds);
           NewPetroModId = setDiffer(1);
       end
       % =========================================================          
