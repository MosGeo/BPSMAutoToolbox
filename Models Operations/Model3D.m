classdef Model3D < Model
   ...
   methods
        ...
        % =========================================================          
        function obj = Model3D(modelName, PMProjectDirectory)
            ...
            % Model ts and blocks
            inDirectory = fullfile(PMProjectDirectory,['pm', num2str(3), 'd'], modelName, 'in');
            ...
            obj = obj@Model(modelName, PMProjectDirectory, 3, tables); 
        end
        % =========================================================          
